...
const darkTheme: Theme = {
  autoAccept: 'rgb(255,180,80)', // Warm orange-gold
  bashBorder: 'rgb(255,160,80)', // Golden orange
  claude: 'rgb(180,120,255)', // Soft purple (main brand accent)
  claudeShimmer: 'rgb(210,170,255)', // Lighter purple shimmer
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(160,130,255)', // Purple for system spinner
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(190,165,255)', // Lighter purple shimmer
  permission: 'rgb(200,160,255)', // Light purple
  permissionShimmer: 'rgb(225,195,255)', // Lighter purple for shimmer
  planMode: 'rgb(140,180,100)', // Muted lime green
  ide: 'rgb(140,110,210)', // Muted purple
  promptBorder: 'rgb(120,100,180)', // Dark purple-gray
  promptBorderShimmer: 'rgb(155,135,210)', // Lighter purple-gray shimmer
  text: 'rgb(255,255,255)', // White
  inverseText: 'rgb(0,0,0)', // Black
  inactive: 'rgb(160,150,170)', // Warm light gray with purple tint
  inactiveShimmer: 'rgb(195,185,205)', // Lighter warm gray shimmer
  subtle: 'rgb(85,75,95)', // Dark purple-gray
  suggestion: 'rgb(220,180,100)', // Warm gold
  remember: 'rgb(220,180,100)', // Warm gold
  background: 'rgb(140,100,220)', // Medium purple
  success: 'rgb(100,220,160)', // Emerald green
  error: 'rgb(255,95,120)', // Rose red
  warning: 'rgb(255,200,60)', // Bright gold
  merged: 'rgb(255,180,80)', // Warm orange-gold (matches autoAccept)
  warningShimmer: 'rgb(255,225,110)', // Lighter gold shimmer
  ...
  // Agent colors
  red_FOR_SUBAGENTS_ONLY: 'rgb(255,95,120)', // Rose red
  blue_FOR_SUBAGENTS_ONLY: 'rgb(120,140,255)', // Periwinkle blue
  green_FOR_SUBAGENTS_ONLY: 'rgb(100,220,160)', // Emerald
  yellow_FOR_SUBAGENTS_ONLY: 'rgb(255,200,60)', // Gold
  purple_FOR_SUBAGENTS_ONLY: 'rgb(180,120,255)', // Soft purple
  orange_FOR_SUBAGENTS_ONLY: 'rgb(255,160,80)', // Golden orange
  pink_FOR_SUBAGENTS_ONLY: 'rgb(255,120,180)', // Soft pink
  cyan_FOR_SUBAGENTS_ONLY: 'rgb(100,220,220)', // Soft cyan
  // Grove colors
  professionalBlue: 'rgb(140,130,210)', // Purple-blue
  // Chrome colors
  chromeYellow: 'rgb(255,200,60)', // Gold
  // TUI V2 colors
  clawd_body: 'rgb(180,120,255)', // Soft purple (matches brand)
  clawd_background: 'rgb(0,0,0)',
  userMessageBackground: 'rgb(50, 45, 65)', // Dark purple-tinted gray
  userMessageBackgroundHover: 'rgb(65, 58, 80)',
  messageActionsBackground: 'rgb(48, 42, 68)', // Cool purple-gray
  selectionBg: 'rgb(60, 50, 100)', // Dark purple selection
  bashMessageBackgroundColor: 'rgb(55, 48, 70)',

  memoryBackgroundColor: 'rgb(50, 48, 72)',
  rate_limit_fill: 'rgb(180,120,255)', // Soft purple
  rate_limit_empty: 'rgb(85,70,120)', // Dark purple
  fastMode: 'rgb(255,200,60)', // Bright gold
  fastModeShimmer: 'rgb(255,225,110)', // Lighter gold shimmer
  briefLabelYou: 'rgb(200,160,255)', // Light purple
  briefLabelClaude: 'rgb(255,180,80)', // Warm orange-gold
  rainbow_red: 'rgb(255,95,120)',
  rainbow_orange: 'rgb(255,160,80)',
  rainbow_yellow: 'rgb(255,200,60)',
  rainbow_green: 'rgb(100,220,160)',
  rainbow_blue: 'rgb(120,140,255)',
  rainbow_indigo: 'rgb(180,120,255)',
  rainbow_violet: 'rgb(220,100,200)',
  rainbow_red_shimmer: 'rgb(255,155,165)',
  rainbow_orange_shimmer: 'rgb(255,195,130)',
  rainbow_yellow_shimmer: 'rgb(255,225,110)',
  rainbow_green_shimmer: 'rgb(150,240,195)',
  rainbow_blue_shimmer: 'rgb(165,180,255)',
  rainbow_indigo_shimmer: 'rgb(210,170,255)',
  rainbow_violet_shimmer: 'rgb(240,150,225)',
}
